...
public class Client_singleFramebeifen extends JFrame implements ActionListener, KeyListener{
	...
	public Client_singleFramebeifen(Client client, String title) {
		this.client = client;
		init(title);
	}
	...
	public void actionPerformed(ActionEvent e) {
		...
		}else if(e.getSource()==jbt_upload){
